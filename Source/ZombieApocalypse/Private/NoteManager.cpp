...
//         return;
//     }
//     // IT IS IMPERATIVE FOR THE Z VALUE OF THE SPAWN VECTOR OF OUR HITBOXZONES TO BE 200 FOR ANYTHING TO WORK.
//     AActor* HitBoxA = World->SpawnActor<AActor>(HitBoxZoneClass, FVector(0, -310, 800), FRotator::ZeroRotator);
//     if (HitBoxA)
//     {
//         HitBoxA->Tags.AddUnique(FName(TEXT("HitZoneA")));
//     }
//     AActor* HitBoxS = World->SpawnActor<AActor>(HitBoxZoneClass, FVector(0, -110, 800), FRotator::ZeroRotator);
//     if (HitBoxS)
//     {
//         HitBoxS->Tags.AddUnique(FName(TEXT("HitZoneS")));
//     }
//     AActor* HitBoxK = World->SpawnActor<AActor>(HitBoxZoneClass, FVector(0, 110, 800), FRotator::ZeroRotator);
//     if (HitBoxK)
//     {
//         HitBoxK->Tags.AddUnique(FName(TEXT("HitZoneK")));
//     }
//     AActor* HitBoxL = World->SpawnActor<AActor>(HitBoxZoneClass, FVector(0, 310, 800), FRotator::ZeroRotator);
//     if (HitBoxL)
//     {
